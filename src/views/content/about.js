...
function About() {
    return (
          <div className='grid grid-cols-1 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2'>
            ...
            <div className='text-yellow tracking-wider leading-loose z-30 '>
             <div data-aos-duration='2000' data-aos="fade-right" data-aos-delay="200" className='bg-black p-8 2xl:p-16 xl:p-16 lg:p-16 md:p-16 '>
             <p className='text-white'>ABOUT US</p>
            <p className="text-left">Katama Waweru Advocates is a progressive reputable medium sized firm dedicated to providing 
